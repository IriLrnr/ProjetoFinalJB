...
ind.loc <- read.csv(file = "./data/position/indlocV2_2_r.csv", sep = ";")
...
# save gif
anim_save("complete_position_V2_2_r.gif", animate(anim, nframes=ngen, height=450, width=550), path = "./gifs")
